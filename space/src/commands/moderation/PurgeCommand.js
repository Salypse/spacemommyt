...
module.exports = class PurgeCommand extends BaseCommand {
  ...
  async run(client, message, args) {
    if (!message.member.hasPermission("MANNAGE_MESSAGES")) return message.channel.send('You do not have permissions to perform this command')
    if (!message.guild.me.hasPermission("MANNAGE_MESSAGES")) return message.channel.send("I do no have \`MANAGE_MESSAGES\` permission")
